        ...
        .prompt([
            {
                ...
                choices: [
                    ...
                    { name: 'Remove a Role', value: 'DELETE_ROLE' },
    ...
    async function addRole() {
        inquirer
            .prompt([
                ...
                const role = res;
                db.handleAddRole().then(() =>
                db.addRole(role, role.department_id).then(() => {
    ...
    async function updateEmployeeRole(){
        inquirer
            .prompt([
                ...
                const employee = res;
                db.handleAddEmployeeRole().then(() =>
                db.updateEmployeeRole(employee.employee_id, employee.role_id).then(() => {
